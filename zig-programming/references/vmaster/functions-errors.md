...
1/1 test_assertion_failure.test.this will fail...thread 2437940 panic: reached unreachable code
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/test_assertion_failure.zig:3:14: 0x1032039 in assert (test_assertion_failure.zig)
    if (!ok) unreachable; // assertion failure
             ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/test_assertion_failure.zig:8:11: 0x103200e in test.this will fail (test_assertion_failure.zig)
    assert(false);
          ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/compiler/test_runner.zig:248:25: 0x1175b19 in mainTerminal (test_runner.zig)
        if (test_fn.func()) |_| {
                        ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/compiler/test_runner.zig:71:28: 0x116f70a in main (test_runner.zig)
        return mainTerminal();
                           ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:695:22: 0x116acc7 in callMain (std.zig)
            root.main();
                     ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:241:5: 0x116a7a1 in _start (std.zig)
    asm volatile (switch (native_arch) {
    ^
error: the following test command crashed:
/home/ci/actions-runner/_work/zig-bootstrap/out/zig-local-cache/o/5220bb110ff3bb4367f0c01aa7b30fb1/test --seed=0xc0538b18
...
Function bodies are [comptime](33-comptime.md#comptime)-only types while function [Pointers](13-pointers.md#Pointers) may be
runtime-known.
...
compile-time known are treated as [Compile Time Parameters](45-c.md#Compile-Time-Parameters). This can potentially
...
`unreachable` invokes safety-checked [Illegal Behavior](40-illegal-behavior.md#Illegal-Behavior), so
...
on [comptime](33-comptime.md#comptime) branches. For example, the Zig standard library uses
...
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:34:5: 0x115576c in bang1 (error_return_trace.zig)
    return error.FileNotFound;
    ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:22:5: 0x11557b6 in baz (error_return_trace.zig)
    try bang1();
    ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:38:5: 0x11557ec in bang2 (error_return_trace.zig)
    return error.PermissionDenied;
    ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:30:5: 0x1155896 in hello (error_return_trace.zig)
    try bang2();
    ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:17:31: 0x115596e in bar (error_return_trace.zig)
        error.FileNotFound => try hello(),
                              ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:7:9: 0x1155a24 in foo (error_return_trace.zig)
        try bar();
        ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:2:5: 0x1155aeb in main (error_return_trace.zig)
    try foo(12);
    ^
...
$ ./stack_trace
thread 2439323 panic: PermissionDenied
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:38:5: 0x115781a in bang2 (stack_trace.zig)
    @panic("PermissionDenied");
    ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:30:10: 0x1157dac in hello (stack_trace.zig)
    bang2();
         ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:17:14: 0x11577d3 in bar (stack_trace.zig)
        hello();
             ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:7:12: 0x1156f48 in foo (stack_trace.zig)
        bar();
           ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:2:8: 0x11565d1 in main (stack_trace.zig)
    foo(12);
       ^
...
and the transformation is guaranteed to be safe. There is one exception, which is [C Pointers](45-c.md#C-Pointers).
...
When a number is [comptime](33-comptime.md#comptime)-known to be representable in the destination type,
it may be coerced:
...
when they are [comptime](33-comptime.md#comptime)-known to be a field of the union that has only one possible value, such as
[void](#void):
...
Explicit casts are performed via [Builtin Functions](37-builtin-functions.md#Builtin-Functions).
