...
However right now it is hard coded to be a `u16`. See [#786](https://github.com/ziglang/zig/issues/786).
...
a panic in [Debug](#Debug) and [ReleaseSafe](#ReleaseSafe) modes and undefined behavior in
[ReleaseFast](#ReleaseFast) and [ReleaseSmall](#ReleaseSmall) modes. So, while we're debugging the
...
/home/ci/actions-runner/_work/zig-bootstrap/zig/docgen_tmp/error_return_trace.zig:30:5: 0x21e513 in hello (error_return_trace)
    try bang2();
    ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/docgen_tmp/error_return_trace.zig:17:31: 0x21e5e0 in bar (error_return_trace)
        error.FileNotFound => try hello(),
                              ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/docgen_tmp/error_return_trace.zig:7:9: 0x21e6b0 in foo (error_return_trace)
        try bar();
        ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/docgen_tmp/error_return_trace.zig:2:5: 0x21e708 in main (error_return_trace)
    try foo(12);
    ^
