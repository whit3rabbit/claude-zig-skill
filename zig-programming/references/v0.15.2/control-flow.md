...
[comptime](33-comptime.md#comptime)-known, then it can be lowered to an unconditional branch
...
captured value [comptime](33-comptime.md#comptime).
...
- You need the loop to execute at [comptime](33-comptime.md#comptime) for the semantics to work.
